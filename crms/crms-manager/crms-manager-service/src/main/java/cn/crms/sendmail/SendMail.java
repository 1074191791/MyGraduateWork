...
/**
 * @author zhous
 * @create 2019-03-22 17:11
 */
public class SendMail {

    private String user = "1074191791@qq.com";//用户名
    private String pwd = "guqkddblocbefhic";//密码
    private String mess = "可以，很强";
    private InternetAddress[] addr;
    ...
    public void setAddr(InternetAddress[] addr) {
        this.addr = addr;
    }
    ...
    public void send() {
        ...
        try {
             addr = new InternetAddress[]{
                    //消息接收者(收件地址，昵称)
                    //不过这个昵称貌似没有看到效果
                    new InternetAddress("1429526644@qq.com", "大师兄"),
            };
            ...
            message.setFrom(new InternetAddress(user, "机房二师兄"));
